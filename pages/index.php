          ...
          <div class="row">
              ...
              <div class="col-md-8 col-1">
                ...
                <div class="card-footer text-muted">
                  you are visitor no <span class="badge badge-dark">102910</span>
                </div>
              </div>
              ...
              <div class="col-md-4 col-6">
                ...
                <div class="card text-light bg-dark border-info mb-3">
                  <!-- <div class="card-header">Register Complain</div> -->
                    ...
                    <form action="../phppages/regcomp.php" method="POST">
                      <div class="card-body">
                      <div class="form-group">
                        <h4 class="card-title ">To Register The Complain</h4>
                         </br>
                        <p class="card-text"><p> UserName</p><input type="email" name="reguname" class="form-control form-control-lg" id="compreguname" aria-describedby="emailHelp" required placeholder="Enter Your UserName"></p>

                        <p class="card-text"><p>Password</p><input type="password" name="compregpass" class="form-control form-control-lg" id="compregpass" aria-describedby="emailHelp" required placeholder=" Enter Your Password"></p>

                         <small id="emailHelp" class="form-text text-muted text-center">Use at least one letter, one numeral, and eight characters.</small>
                         </br>  
                        <input type="submit" value="Log me in" class="btn btn-outline-light btn-lg btn-block "></input>

                         <small id="emailHelp" class="form-text text-muted text-center"> By clicking "log Me In", you agree to our terms of service and privacy policy. We May occasionally send you emails.</small>
